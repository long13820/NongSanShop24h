								...
								<div class="aa-footer-widget">
									...
									<ul class="aa-footer-nav">
										...
										<li><p
												...
												nơi chuyên buôn bán tất cả các mặt hàng về nông sản chất
							...
							<div class="col-md-4 col-sm-6">
								<div class="aa-footer-widget">
									<div class="aa-footer-widget">
										<h3>LIÊN HỆ</h3>
										<address>
											<p>97 - Man Thiện - phường Hiệp Phú - Thành phố Thủ Đức -
												TPHCM</p>
											<p>
												<span class="fa fa-phone"></span>091.790.6458
											</p>
											<p>
												<span class="fa fa-envelope"></span>webnongsan24@gmail.com
											</p>
										</address>
